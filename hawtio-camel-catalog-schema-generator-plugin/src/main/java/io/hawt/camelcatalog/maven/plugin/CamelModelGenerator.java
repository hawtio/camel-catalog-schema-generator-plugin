...
public class CamelModelGenerator {
	...
	private void camelCatalogExtract(URL camelCatalogDir, String dataPath, BiConsumer<String, String> callback) throws MojoFailureException {
	...
	private void writeObjectsToSchema(Map<String, String> objects, String category, String parent, FileOutputStream fos) throws IOException {
		Iterator<String> it;
		fos.write(("  \"" + category + "\": {\n").getBytes());
